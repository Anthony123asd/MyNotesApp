package com.dicoding.kotlin.mynotesapp.provider
...
import com.dicoding.kotlin.mynotesapp.db.DatabaseContract.AUTHORITY
import com.dicoding.kotlin.mynotesapp.db.DatabaseContract.NoteColumns.Companion.CONTENT_URI
import com.dicoding.kotlin.mynotesapp.db.DatabaseContract.NoteColumns.Companion.TABLE_NAME
...
class NoteProvider : ContentProvider() {
    ...
    companion object{
       ...
       //Integer digunakan sebagai identifier antara select all sama select by id
         ...
         */
        init {
            //content://com.dicoding.kotlin.mynotesapp/note
            sUriMatcher.addURI(AUTHORITY, TABLE_NAME, NOTE)
            //content://com.dicoding.kotlin.mynotesapp/note/id
